...
public class Temperature extends Sensor<GroveTemperatureAndHumiditySensor> {
    public Temperature(String board, String name, GrovePiPort port, GrovePi grove, GroveTemperatureAndHumiditySensor.Type type) {
